...
export const artists: Artist[] = [
  {
    ...
    bio: 'Elsa Maritz is an interdisciplinary artist who explores themes of landscape, spirit, and vulnerability. Her practice invites viewers into worlds intertwined with nature and inner landscapes, drawing from mythology, ritual, and personal narrative.',
    statement:
      'Working primarily in photography, Maritz creates poetic black-and-white images that suggest mythic encounters between humans and landscape, navigating documentary and dreamlike states.',
    portrait: 'https://arkcontemporary.co.za/wp-content/uploads/2024/11/Elsa-Bio-1-683x1024.jpg',
    website: 'https://www.elsamaritz.com',
    works: [
      { id: 'em1', title: 'Untitled, Swell Series', artist: 'Elsa Maritz', medium: 'Photography', size: 'As listed', image: 'https://arkcontemporary.co.za/wp-content/uploads/2024/11/Limb_limbic.jpg' },
      ...
      { id: 'em3', title: 'The Womb, Nov 2022 – Jun 2023', artist: 'Elsa Maritz', medium: 'Photography', size: 'As listed', image: 'https://arkcontemporary.co.za/wp-content/uploads/2024/11/womb.jpg' }
    ]
  },
  {
    slug: 'grietjie-lee',
    ...
    bio: 'Grietjie Lee is an experimental and explorative artist based in Rosendal, South Africa. Her work investigates human-machine entanglements, consciousness, and tensions between ecology, technology, science, and spirituality.',
    statement:
      'Lee challenges technological status quo by returning to symbolism and spiritual cues of nature and folklore, mapping geographic space, time, and emotion through code and colour.',
    ...
    works: [
      ...
      { id: 'gl3', title: 'Nocturnal, 2023', artist: 'Grietjie Lee', medium: 'Mixed media / oil pastel and beeswax', size: '160 mm x 120 mm', image: 'https://arkcontemporary.co.za/wp-content/uploads/2023/10/Nocturnal2.jpg' }
    ]
  },
  {
    slug: 'louis-olivier',
    ...
    bio: 'Louis Olivier is a sculptor based in Johannesburg. His work explores mortality, existence and the afterlife through sculpture, drawing, and installation.',
    statement:
      'By deconstructing and reassembling the human figure, Olivier investigates interior space, memory, and emotional states of strength, vulnerability, honesty and humility.',
    ...
    works: [
      ...
      { id: 'lo2', title: 'A Story with a Strange Beginning', artist: 'Louis Olivier', medium: 'Bronze', size: '370 x 80 x 80 mm · Edition 8', image: 'https://arkcontemporary.co.za/wp-content/uploads/2023/10/louis_olivier_2017_22.jpg' },
      { id: 'lo3', title: 'Hornbill', artist: 'Louis Olivier', medium: 'Collage, ink and charcoal on paper', size: '1120 x 1515 mm', image: 'https://arkcontemporary.co.za/wp-content/uploads/2023/10/louis_olivier_2017_14.jpg' }
    ]
  },
  {
    ...
    bio: 'Michèle Nigrini is an award-winning South African artist working primarily in mixed media and painting. Her practice explores abstraction through layered mark-making, gesture, and texture.',
    statement:
      'Nigrini’s work reflects emotional landscapes and internal dialogues through dynamic compositions and layered surfaces.',
    ...
    works: [
      ...
      { id: 'mn3', title: 'Should We Know You – Study', artist: 'Michèle Nigrini', medium: 'Mixed media on canvas', size: '120 cm x 75 cm', image: 'https://arkcontemporary.co.za/wp-content/uploads/2023/10/Chain-Reaction-80-x-80-x-4cm-mixed-media-on-wooden-canvas-scaled.jpg' }
    ]
  },
  {
    slug: 'stella-olivier',
    ...
    statement:
      'Her drawings combine her own images with vintage photography to construct narratives that never existed, speaking to a personal subliminal journey.',
    ...
    works: [
      ...
      { id: 'so2', title: 'Split, 2022', artist: 'Stella Olivier', medium: 'Charcoal and ink', size: '55 cm x 75 cm', image: 'https://arkcontemporary.co.za/wp-content/uploads/2023/10/IMG_2731.jpg' },
      { id: 'so3', title: 'Entrado, 2021', artist: 'Stella Olivier', medium: 'Charcoal and ink', size: '45.5 cm x 37 cm', image: 'https://arkcontemporary.co.za/wp-content/uploads/2023/10/IMG_8596.jpg' }
    ]
  },
  {
    ...
    bio: 'Wessel van Huyssteen is a South African artist whose practice centers around layered abstraction, dynamic color fields, textured surfaces, and gestural mark-making.',
    statement:
      'Working primarily in mixed media on canvas, his process balances chaos and control, density and openness, and evokes landscape, memory, and psychological space.',
    ...
    works: [
      { id: 'wv1', title: 'Fields, 2020', artist: 'Wessel van Huyssteen', medium: 'Oil on canvas', size: 'As listed', image: 'https://arkcontemporary.co.za/wp-content/uploads/2023/10/Kankerbos.-2023.-300X400.-Watercolour-on-paper-scaled.jpg' },
      { id: 'wv2', title: 'Concrete Memory, 2021', artist: 'Wessel van Huyssteen', medium: 'Oil and mixed media on canvas', size: 'As listed', image: 'https://arkcontemporary.co.za/wp-content/uploads/2023/10/The-hand-that-guides-the-needle-2023-1200x1730-Hand-and-machine-stitched-Rayon-Cotton-and-Viscos-scaled.jpg' },
      { id: 'wv3', title: 'Over and Under, 2023', artist: 'Wessel van Huyssteen', medium: 'Mixed media on canvas', size: 'As listed', image: 'https://arkcontemporary.co.za/wp-content/uploads/2023/10/Scape-sans-sky.2023.-Rayon-Viscos-Nylon-Cotton.-1725x1105-1-scaled.jpg' }
    ]
  }
];

export const featuredArtworks = artists.flatMap((a) => a.works).slice(0, 6);

export const exhibitions: { current: Exhibition; past: Exhibition[]; callouts: { title: string; dates: string; description: string }[]; spaceImages: string[] } = {
  current: {
    slug: 'summer-2026-exhibition',
    title: 'Summer 2026 Exhibition',
    dates: '6 January 2026 – 31 January 2026',
    description:
      'The Summer Exhibition 2026 is a contemporary showcase bringing together a diverse selection of works by Rosendal-based artists across painting, photography, sculpture, and mixed media.',
  ...
  past: [
    {
      ...
      dates: 'Spring 2025',
      description: 'A vibrant spring exhibition bringing together photography, tapestry, painting, sculpture, and mixed media, with new works by Louis Olivier, Stella Olivier, Grietjie Lee, and Wessel van Huyssteen.',
    ...
    },
    {
      ...
      description: 'Celebrating the season of ark.contemporary, Fertile Ground brings together artists around themes of renewal, memory, and place. Curated by Wessel van Huyssteen in collaboration with Grietjie Lee.',
    ...
    },
    {
      ...
      description: 'Fresh new works from gallery artists and invited guests, featuring Louis Olivier, Wessel van Huyssteen, Stella Olivier and other remarkable creatives.',
  ...
  callouts: [
    {
      ...
      description: 'A new-year exhibition celebrating gallery artists and invited guest artists.'
    },
    {
      title: 'Gallery Raffle',
      dates: 'December 2024',
      description: 'Held on 21 December 2024 with refreshments, live music, and a raffle draw supporting the local art scene.'
    },
    {
      title: 'Equilibrium',
      dates: 'April 2022 – May 2022',
      description: 'A Free State Art Collective exhibition curated by Karen Birch, exploring personal narrative and dynamic balance between illusion and reality.'
    }
  ],
  spaceImages: [
